  ...
  async function verHistorial(equipoId) {
    ...
    try {
      ...
      c.innerHTML = `
        ...
        (r.eventos || []).map((e) => {
          const etiqueta = e.clase === 'intervencion'
            ? (e.tipo_trabajo || 'trabajo').replace(/_/g, ' ')
            : e.clase === 'correctivo' ? 'desvío detectado' : 'alta';
          return `<div class="prev-hito">
            <div class="prev-hito-cab">
              <span class="prev-chip ${e.clase === 'correctivo' ? 'amar' : 'gris'}">${esc(etiqueta)}</span>
            ...
            ${e.extra ? `<div class="prev-hito-det">Repuestos: ${esc(e.extra)}</div>` : ''}
