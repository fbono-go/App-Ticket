...
(function () {
  ...
  async function renderInicio() {
    ...
    cont.innerHTML = `
      ...
      <button class="prev-btn prev-sec" onclick="PREV.escanear('historial')" ${inst ? '' : 'disabled'}>
        <i class="ti ti-history"></i> Ver el historial de un equipo
      </button>
      <div id="prev-ultimos"></div>` : `
      ...
      <div class="prev-hint">Escaneá cualquier equipo para ver todo lo que se le hizo:
        preventivos, reparaciones y desvíos.</div>
  ...
  function abrirModulo(cual) {
    seccion = cual === 'correctivo' ? 'correctivo' : 'preventivo';
    const boton = seccion === 'correctivo' ? 'bn-corr' : 'bn-prev';
